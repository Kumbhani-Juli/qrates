...
const recordsPageProjectsData = [
	{
		...
		genreData: [{ genreList: "Electronic" }, { genreList: "Techno" }],
		projectPrice: 15.25,
		moneyType: "€",
	...
	},
	{
		...
		genreData: [{ genreList: "Rock" }, { genreList: "Punk" }],
		projectPrice: 25.0,
		moneyType: "$",
			...
			middleSectionData: {
				aboutData: {
					...
					contentData: [
						{
							content:
								"Reptile Rage is back. This time with a revised version of King Gizzard & the Lizard Wizard's first EP, Anglesea. While not as groundbreaking as their later works like Flying Microtonal Banana or Polygondwanaland, it's part of the band's history. Despite being available as part of the band's compilation, Teenage Gizzard, The EP has seldom been reissued on its own. Stu says it's not canon, but that's what the bootlegger program is all about.",
						},
						{
							content:
								"The design for this version was based on an old Beatles EP from the UK, a 7 inch 45 RPM record with two songs per side. Unfortunately, the sides on Anglesea are a hair too long for a 7 inch 45, and to cut a 7 inch at 33 1/3 RPM would mean the whole record would have suffered inner groove distortion. In order to preserve audio quality, I've upgraded to a 10 inch. Coupled with excellent remasters for vinyl by Angel Hair Audio (provided by Needlejuice Records), this is pressing will sound great.",
						},
						{
							content:
								"It was necessary to upscale Katie Hagebols's original artwork to make it suitable to print. The new version was done with an AI upscaler, and I think you'll be pleased with the results. This will probably be the best this artwork has looked. Special thanks to Deaf Hammers for help designing the back cover and label designs, inspired by The Beatles' EP, Twist and Shout. The record itself will be on clear green vinyl, and the jacket will have a serial number on the back.",
						},
						{
							content:
								"I've set the minimum number of pledges to 200 this time to keep the price reasonable. Some will be set aside to send to the band, and some to be available for sale later. I'd like to get as close to 200 as I can, but consider this a pre-order rather than a crowdfunding campaign. Thanks for helping me will this record into existence.",
						},
					],
				},
				tracklistData: [
				...
				profileSectionData: {
					...
					contentData: [
						{
							content:
								"Making King Gizzard & the Lizard Wizard bootlegs since 2023.",
						},
					],
				},
			},
			...
			middleSectionData: {
				aboutData: {
					...
					contentData: [
						{
							content:
								"'Gizz Jams', a new vinyl series from Domestic Ham Records, celebrates King Gizzard's longest live cuts.",
						},
						{
							content:
								"Volume One highlights two tracks from 'Live at Red Rocks '22': a nineteen-minute cut of The River which features Crumbling Castle and Wah Wah teases and an eighteen-and-a-half-minute Her and I (Slow Jam II) which features Magma, Slow Jam I, Cut Throat Boogie, and Flamethrower teases. Both tracks are mastered for vinyl.",
						},
					],
				},
				tracklistData: [
				...
				profileSectionData: {
					...
					contentData: [
						...
						{
							content:
								"I'm a huge fan of King Gizzard and the Lizard Wizard, and I was inspired by their Official Bootlegger program to create Domestic Ham Records. I love how this program allows fans to share and appreciate King Gizzard's music in a unique and engaging way. I'm excited to continue this tradition with my own label.",
						},
						{
							content:
								"If my first campaign is successful, I hope to build this into a collectable series of fan-curated releases, where fellow fans help shape the direction of future releases.",
						},
					],
				},
			},
			...
			middleSectionData: {
				aboutData: {
					...
					contentData: [
						{
							content:
								"It's a techno dance maybe rock music from Canada. I'm new producer.",
						},
					],
				},
				tracklistData: [
			...
			middleSectionData: {
				aboutData: {
					...
					contentData: [
						{
							content:
								"To celebrate the forthcoming release of the Trio's feature film, 'BRETTROSPECTIVE', Brett Domino returns with an album of songs spanning the last 10 years - available for the first time on vinyl...",
						},
						{
							content:
								"Features 'Can't Go Back' from the Brettrospective film - a Bond-style movie theme written by AI.",
						},
						{
							content:
								'Limited run 12" black vinyl (33rpm), individual serial number, full-colour sleeve + photo insert, plus digital download card + bonus digital track.',
						},
					],
				},
				tracklistData: [
			...
			middleSectionData: {
				aboutData: {
					...
					contentData: [
						{
							content:
								'In 2023, marking the 50th anniversary of Okinawas return to Japan after the war, a non-fiction talk show, Uemara Yoshitoshis solo performance "Henkyou FRONTIER - Okinawa Yin Yang" was held. This',
						},
						{
							content:
								"unusual event depicted Okinawa's complex history, identity, trauma, and potential, and questioned the future of a new Okinawa, with both the lectures in Naha and Nago sold out.",
						},
						{
							content:
								'"Kunjikane Iro" was the ending song, expressing Okinawas intricate history and charm, deep pride, and hope for the future.',
						},
						{
							content:
								"The song was produced by up-and-coming artists from Okinawa,",
						},
						{
			...
			middleSectionData: {
				aboutData: {
					...
					contentData: [
						{
							content:
								'The debut album from Monterey J on high quality vinyl (limited to 100 copies).Including the singles "Person To Person", "Worlds", "10 Hours", "Before The House Burns Down", "Birthright", and more.',
						},
					],
				},
				tracklistData: [
				...
				profileSectionData: {
					...
					contentData: [
						{
							content:
								"Monterey J is a musician and producer based in South London. His music fuses funk, hip hop-flavored beats and jazz harmony to create a unique mix of grooves.",
						},
					],
				},
			},
	...
	},
	{
		...
		genreData: [{ genreList: "Country/Folk" }, { genreList: "Pop" }],
		projectPrice: 19.99,
		moneyType: "$",
		footerContent: "pre-order",
		projectDetailsData: {
			...
			middleSectionData: {
				...
				profileSectionData: {
					...
					contentData: [
						...
						{
							content:
								"Jerry Collins is a author, ghost hunter, Christian Music Artist and a commercial music artist, who has ranked",
						},
	...
	},
	{
		...
		projectDetailsData: {
			...
			middleSectionData: {
				aboutData: {
					title:
						"Regrets Only | No dress code | No gifts | No waiting | No pining | No sleeping in the rose bed |",
					contentData: [
						{
							content:
								"The album was born in a hotel room shower in the fall of 2021. Raw from isolation trauma and battling creative doubts, I drove up to see a show in Eau Claire, WI, for the first time since the pandemic struck. I was slowly coming back to making music after years away, and the inner whispers were loud: It’s too late, you shouldn’t have quit back then, you’re embarrassing yourself now.",
						},
						{
							content:
						...
						{
							content:
								"That night, I started the lyrics to “Oxbow Shower,” which turned into track #2, a wry manifesto on harnessing regret to motivate action. I went home, finished up the demos I’d been quietly stashing, and sent them to producer Zach Hanson (who I’d met hosting a living room show for S. Carey years ago). He understood what I wanted to make, and, now, here it is: an album that sounds like me when I don’t quit, settle or hide. I hope Regrets Only whispers to others to do the same.",
						},
						{
							content:
								"The album includes a very special insert with liner note poetical responses to each song by Teresa Leggard.",
						},
					],
				},
				tracklistData: [
				...
				profileSectionData: {
					...
					contentData: [
						{
							content:
								"Songwriter Sarah Magill makes music for feelers as Quiet Takes. A writer and wanderer, Magill has a nomadic creative practice and is releasing her first full-length album, Regrets Only, recorded in Eau Claire, Wisconsin, with producer Zach Hanson (S. Carey, Bon Iver, Gordi).",
						},
					],
				},
			},
	...
	},
	{
		...
		artistTitle: "GXNXSIS",
		genreData: [{ genreList: "Hiphop/Rap" }, { genreList: "Down-tempo" }],
		projectPrice: 18.0,
		moneyType: "£",
		footerContent: "in-stock",
		projectDetailsData: {
			...
			middleSectionData: {
				...
				profileSectionData: {
					...
					contentData: [
						{
							content:
								"Aviary Bridge Records is both a record label and a collective of artists. It was created by artists and is operated with the benefit to its artists foremost in mind.",
						},
						{
							content:
	...
	},
	{
		...
		artistTitle: "V.A.",
		genreData: [{ genreList: "Reggae" }, { genreList: "Pop" }],
		projectPrice: 25.0,
		moneyType: "£",
		footerContent: "in-stock",
		projectDetailsData: {
			...
			middleSectionData: {
				aboutData: {
					...
					contentData: [
						...
						{
							content:
								"Release this autumn, Tokyo Riddim 1976-1985 is part of Time Capsule's Nippon Series, a loose series of compilations exploring different musical scenes from Japan between the 1970s and 1990s.",
						},
					],
				},
				tracklistData: [
				...
				profileSectionData: {
					...
					contentData: [
						{
							content:
								"“What you are hearing is an offering to any and all future beings. We are sealing some of the thoughts and feelings, the vibrations of our day In what you may call a me capsule, which itself has been sealed with cosmic love”",
						},
		...
		projectDetailsData: {
			...
			middleSectionData: {
				...
				profileSectionData: {
					...
					contentData: [{ content: "John Splithoff" }],
				},
			},
		},
	},
	{
		...
		genreData: [{ genreList: "Techno" }, { genreList: "Electronic" }],
		projectPrice: 25.0,
		moneyType: "$",
		footerContent: "in-stock",
		projectDetailsData: {
			...
			middleSectionData: {
				...
				profileSectionData: {
					...
					contentData: [
						{
							content:
								"WeTurnToRed (a.k.a. Shamanta Chandran) is a Syrian-born Tamil-Canadian producer/DJ/ singer/songwriter, and scientist based in Toronto. Growing up on the city's outskirts, she studied and classically trained in opera and jazz as an arts high school kid. Her deep love for electronic music was ignited after her older brother introduced her to the mid-90s Toronto rave scene.",
						},
						{
							content:
								"After experimenting in the studio for over a decade, delving into melodic nuances of modular and analog synths, it was clear that growling basslines and haunting melodies were the subjects of her affection. She made her mark in Toronto's electronic music scene through live hardware deep house/techno-focused sets. As a DJ, she is a quality selector of many genres—everything from hip-hop, reggae, house, techno and what's in between.",
						},
						{
							content:
								"Some notable music releases include Planet E Detroit Love-Vol 5, MSTRKRFT's ORO Records, and Cosmic Resonance (Toronto). Her debut EP, Smoked Glass on PITS (Detroit), garnered acclaim, leading to features on Stamp the Wax and Rinse France to name a few.",
						},
						{
							content:
								"As a South Asian woman in the electronic modular space, WeTurnToRed is an artist to look out for.",
						},
					],
				},
			},
			...
			middleSectionData: {
				aboutData: {
					...
					contentData: [
						{
							content:
								'From the mind of 20-year-old Singer/Broadway Actor Max Bartos comes his second LP "Memento Mori". Memento Mori chronicles a ghosts last day on earth before he fades away into oblivion, and he has but one wish. To see the love of his life one last time. Will he? Or will he end up as another forgotten soul haunting this misty lighthouse.',
						},
					],
				},
				tracklistData: [
				...
				profileSectionData: {
					...
					contentData: [
						{
							content:
								"Max Bartos is a twenty-year-old singer/actor from New York City, best known for originating the role of Darren in Sing Street the musical. A self-taught musician that plays six instruments including both acoustic and electric guitar as well as piano, drums, bass, banjo, and mandolin, Max uses these talents to create a unique musical soundscape. Described as a “Romantic Folk Rock” artist, Max derives inspiration from his Musical Theatre/Broadway background with influences like Duncan Sheik, and seamlessly blends it with his love of Alt Rock and Folk from bands/artists like Noah Kahan, My Chemical Romance, Dashboard Confessional, and Green Day.",
						},
					],
				},
			},
			...
			middleSectionData: {
				...
				profileSectionData: {
					...
					contentData: [
						{
							content:
								"Hey I'm GRANT. I'm a 21-year-old, Dallas, Texas-bred and LA-based artist, producer & songwriter. At age 11, I became obsessed with Logic and taught myself to write and produce in my bedroom. I'd like to describe my music as synth-driven, deep bass, and intimate pop songs that've all been written and produced by me :)",
						},
						{
							content:
								"In 2022, GRANT came out as a part of the LGBTQ+ community by telling his dad with his song, FIRST HELLO. FIRST HELLO went viral gaining over 80M+ views across the internet changing GRANT's life & multiple others who have been inspired by or come out using the song. FIRST HELLO is out now!",
						},
						{
							content:
								"Grant placed 4th on NBC's, American Song Contest, with his self-produced & co-written new song, MR. INDEPENDENT'. He performed on live TV in front of millions & was voted to the Grand Final by America placing 4th out of 56 artists & songs. Gathering over 2M followers, Grant has spent most of his life on the road performing 160+ shows across America including on The Today Show, Radio City Music Hall, and many others. GRANT has been featured on top playlists like New Music Friday, Young & Free, Teen Beats, New Music Daily, & more! He's also been featured by media outlets like Rolling Stone, Variety, Pop Crave, & was named One of today’s finest rising pop stars. by Ones To Watch. He's even been seen across billboards nationwide with Hinge's latest NFAQ campaign.",
						},
						{
							content:
								"Grant's highly anticipated 3rd EP, I COULD DIE JUST THINKING OF US is out everywhere October 20th.",
						},
					],
				},
			},
			...
			middleSectionData: {
				...
				profileSectionData: {
					...
					contentData: [
						...
						{
							content:
								"Rob attended Berklee College of Music in Boston, MA, where a number of his songs are currently taught in songwriting classes. Rob has written songs for and shared the stage with Grammy/Tony winners and legends Joe Cocker, Sara Ramirez, Harry Shearer, Christopher Guest, Neil Finn, Andy Summers of The Police, and produced or co-produced over twenty albums for himself and others. He is a father of three girls and is studying to become a licensed marriage and family therapist (LMFT).",
						},
					],
				},
			},
	...
	},
	{
		...
		projectDetailsData: {
			...
			middleSectionData: {
				aboutData: {
					title:
						"Bulgarian Beat Wave Returns With an Expansive Volume 2 Edition",
					contentData: [
						{
							content:
				...
				profileSectionData: {
					...
					contentData: [
						{
							content:
								"After building our Stereofox community and supporting artists for over 8 years, starting this label felt like the next logical step and the last missing piece of the puzzle.",
						},
						{
							content:
								"We want to follow the same principles of professionalism and integrity we follow when writing features or working with artists. We always put their needs and interests first. We are proud of what we do, and we do it with a positive mindset.",
						},
						{
							content:
						...
						{
							content:
								"We hope you enjoy the projects we put out and the artists we support. There are tons of talented musicians out there and we're beyond happy to be part of their journey and help them whether that's through the label or on our website.",
						},
					],
				},
			},
	...
	},
	{
		...
		artistTitle: "MARTER",
		genreData: [{ genreList: "soul" }, { genreList: "R&B" }],
		projectPrice: 2000,
		moneyType: "¥",
		footerContent: "pre-order",
		projectDetailsData: {
			...
			middleSectionData: {
				aboutData: {
					title:
						"Two spacey, spiritual R&B tunes by MARTER released in 2021 have finally been released on vinyl.",
					contentData: [
						{
							content:
								"Overwhelming sense and reality cultivated around the world.",
						},
						{
							content:
								"Soul-R&B filled with a spacey and spiritual worldview, released by MARTER in 2021.",
						},
						{
							content:
								"A coupling of two songs, Make a Stand feat. Kojoe and Transformation.",
						},
						{
							content:
								"Born in Tokyo, he spent his impressionable teenage years in the United States, studied music at Berklee College of Music, and was active in Europe in his late twenties.",
						},
						{
							content:
								"The original US neo-soul elements are mixed with the cool sound cultivated in Europe, and delicate and soulful vocals are intertwined. This is MARTER's first analog release in five years.",
						},
					],
				},
				tracklistData: [
				...
				profileSectionData: {
					...
					contentData: [
						{
							content:
								"An artist who writes lyrics, composes music, arranges, produces, sings, and performs all by himself.",
						},
						{
							content:
								"Moved to LA at the age of 13. In high school, he fell in love with the bass and decided to pursue a career in music. After graduating from high school, he went on to Berklee College of Music. He studied bass, composition, and improvisation, and gained experience performing in many bands.",
						},
						{
							content:
								"After graduating from university, he went to London and received offers to join many bands, but returned to Japan.",
						},
						{
							content:
								"After returning to Japan, he formed the jam band POSH, which became a hot topic among cutting-edge musicians. After POSH disbanded, he released ``Jukai'' and ``Tsuki no Rise Shio'' in 2002, recorded at home using CUBASE. He was highly praised by the media and musicians both in Japan and abroad. ",
						},
					],
				},
			},
	...
	},
	{
		...
		projectDetailsData: {
			...
			middleSectionData: {
				aboutData: {
					title:
						"Crowdfunding for unique genre-defying Post-Metal project ' Philanthrop /'",
					contentData: [
						{
							content:
								" Philanthrop / is the latest creation of the Austrian Post-Metal project Ephemeral Sky.",
						},
						{
							content:
								"The record boasts an engaging mix of ethereal Post-Black Metal / Blackgaze, Post-Hardcore, Slam Death Metal, Jazz, Classical Music and even ethnical folk influences. In that regard the music is also quite progressive at times. Even though there is such a multitude of influences from different genres to be found on this record, it presents nonetheless a coherent whole that guides the listener through its narrative soundscapes.",
						},
						{
							content:
								"The record can be described as a concept album, though only in an abstract sense. The lyrical themes deal with ethical and philosophical arguments about human nature and war, however all that is deeply embedded in a layer of purposeful ambiguity. The listener should be able to discern their own meaning from each track and the composition as a whole.",
						},
						{
							content:
								"The vinyl release is limited to 100 pieces, all hand-numbered in red ink. The record itself boasts an impressive three color (ivory sand, clear-red, sky blue) design which naturally preserves the amazing sound quality of the professional vinyl mastering of the audio.",
						},
						{
							content:
								"Sounds like: Alcest, Conjurer, Leprous, Deafheaven, Yann Tiersen, Mike Oldfield, Rome",
						},
						{
							content:
								"There will be NO REPRINT. This is your only chance to get your hands on one of these extremely rare and strictly limited vinyl records.",
						},
					],
				},
				tracklistData: [
			...
			middleSectionData: {
				aboutData: {
					contentData: [
						{
							content:
								"I spent most of 2022 touring solo. In the first shows, I used a one man band setup that people seemed to enjoy. But through the process I learned that connecting with an audience on a deeper level meant stripping away anything that didn't provide a direct link to the songs. I was left with just a piano and a mic. I came home and made this album.",
						},
					],
				},
				tracklistData: [
				...
				profileSectionData: {
					...
					contentData: [
						{
							content:
								"Jake has appeared with Rosalia, Chance the Rapper, Bilal, Meshell Ndegeocello, Nick Hakim, Gabriel Garzon Montano, Benny Sings, and Andrew Bird.",
						},
						{
							content:
								"Two years later, in early 2022, the singles , ‘Humanity in Shards’ and ‘In the Name of‘ have been released. They are the first singles of the upcoming full-length album ‘ Philanthrop /’ (German for ‘philanthropist’). The sound is more energetic, relentless and Hardcore-influenced than on the previous releases. The lyrical themes have shifted from introspection to philosophical and ethical arguments about human behavior, war and religion. The album is scheduled to be released on April 27th.",
						...
						{
							content:
								"And now here he is alone with a piano, performing for you.",
						},
					],
				},
			},
