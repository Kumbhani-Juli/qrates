...
const storiesData = [
	{
		...
		content:
			"Any cross-genre combination of great hooks, powerful melodies, and mass appeal Image: Ari Voxx",
		...
		storiesDetailsData: {
			topSectionData: {
				contentData: [
					{
						content:
							"As the winter night gets colder and shorter, take comfort in the warmth of these powerful pop releases from Qrates.",
					},
					{
						content:
							"There's a seven-inch reissue of Tom Aspaul's Kylie Minogue-covered hit, Ari Voxx & the Sad Lads's retro space pop, Grant Knoche's bold drum n bass, and a new release from Stereofox's always inspiring pop roster.",
					},
				],
			},
			middleSectionData: [
				{
					...
					contentData: [
						{
							content:
								"London-based singer-songwriter celebrates the 10-year anniversary of his career-making single Indiana with an extremely limited edition clear seven-inch vinyl with brand new artwork. First released in 2013 on Little Boots' On Repeat Records, the pop, electro, and atmospheric RnB track was released to critical acclaim, and was eventually covered by pop icon Kyle Minogue.",
						},
						{
							content:
								"Produced by Grammy-nominated artist MNEK, the joyful love song drew comparisons to Britney Spears, Disclosure, and Prince",
						},
						{
							content:
								"This will by Aspaul's second Qrates campaign, following 2020's Black Country Disco synthpop album, inspired by the titular 70s funk and soul offshoot, and telling the story of a tumultuous 18 months in the artist's life. Featuring all new artwork and a second single Pioneer on the B-side, Indiano is a piece of pop music history worth holding on to.",
						},
					],
				},
				{
					...
					contentData: [
						{
							content:
								"This is the Los Angeles-based artist, producer, and songwriter's third EP, featuring ten tracks of experimental, pop renditions of drum n bass, electronica and downtempo styles.",
						},
						{
							content:
								"Only 21 years old, and born and raised in Dallas, Texas, Knoche has been making music from age 11, and writes and produces everything himself. Synths and basslines drive the artist’s intimate lyrics, with tracks like “Icarus and Please Hurry marking opposite ends of the beats-to-ballad spectrum.",
						},
						{
							content:
								"Having amassed a whopping 80 million views for his song debut, “First Hello” in 2022—and publicly announcing himself as a part of the LGBTQ+ community—Knoche’s future is no doubt as bright as the sounds of this latest EP.",
						},
					],
				},
				{
					...
					contentData: [
						{
							content:
								"DC-born performer Ari Voxx leads the Sad Lads on the dynamic album of 80s/90s new-wave and pop, with a smattering of indie and electronica. As a unique fusion including space-age exotica and synth-pop, the band showcases an impressive stylistic range, from the rhythmic post-punk of Flamingo and the expansive baroque pop of Subjective Feeling, resembling the haunting American gothic of Lana Del Rey and Ethel Kain.",
						},
						{
							content:
								"Driven by Voxx's commanding vocal performance, I'm Okay, Please Stop Asking is charged with both the strength and vulnerability of an artist adept at emotional complexity and self-expression.",
						},
					],
				},
				{
					...
					contentData: [
						{
							content:
								"The respective Sofia-based singer and producer teamed up for a delicate, yet empowering nine-piece album, and its intimate blend of RnB, and hip hop.",
						},
						{
							content:
								"Released via Berlin-based music blog-come-label Stereofox, is described by the artists herself as a an intimate, authentic, and vulnerable album that “takes you through my fears, desires, parts of myself I’ve never been honest or brave enough to share.”",
						},
					],
				},
			],
			bottomSectionData: {
				title:
					"Ari Voxx & The Sad Lads / I'm Okay, Please Stop Asking is now available on Qrates.",
			},
		},
	},
	{
		...
		content:
			"An eclectic mix of projects curated by the Qrates team Image: grouptherapy.",
		pageTitle: "Qrates Recommends",
		storiesDetailsData: {
			topSectionData: {
				contentData: [
					{
						content:
							"As autumn arrives, so do the incredible albums with influences and approaches as mottled as the shades of the falling leaves.",
					},
					{
						content:
							"Featuring the soulful jazz covers of Jake Sherman, the city pop and new wave blends of Japanese reggae on Time Capsule's Tokyo Riddim 1976-1985 compilation, a folk music score from Leeds's Archipelago Arts, and an emotionally-charged hip hop and RnB throwback from grouptherapy.",
					},
				],
			},
			middleSectionData: [
				{
					...
					contentData: [
						{
							content:
								"The Brooklyn-based classically-trained pianist follows up a year of touring solo with an album of soul, jump blues, and swing songs that share what he'd learnt on the journey. That is, that the best way to connect with an audience is with nothing more than his instrument and a mic.",
						},
						{
							content:
								"The selection of soulful classics—plus a couple of Sherman's own originals, including his quirky The Comforter— follows Jake Sherman Gets Sexy. That 2021 album honored an appreciation for great songwriting with slow jams reminiscent of 80s and 90s RnB.",
						},
						{
							content:
								"What A Wonderful World, on the other hand, strips back to the basics of blue-eyed soul, along with an eclectic mix of covers that include Randy Newman's Toy Story theme song in You've Got a Friend in Me, and the opening song from Pinocchio's When You Wish Upon a Star. Along with the traditional pop of Pennies from Heaven and a rendition of 1930s jazz standard Body and Soul—featuring Sherman playing harmonica and Larry Goldings on piano—the album is a genuine homage to the past, present, and future of popular songwriting.",
						},
					],
				},
				{
					...
					contentData: [
						{
							content:
								"London-based reissue label Time Capsule captures the moment when reggae gained popularity in Japan in the late 1970s and '80s. The compilation features overlooked tracks from this era, and showcasing artists like Miki Hirayama, Chu Kosaka, Izumi Mimi Kobayashi, Junko Yagami, Miharu Koshi, Marlene, and Lily.",
						},
						{
							content:
								"Instead of directly emulating the Caribbean island’s styles, Japanese producers and artists drew inspiration from the accessible sounds of UK bands like The Police and UB40, blending reggae with city pop and new wave. The intercultural fusion is impeccably echoed in the cover art by Fukuoka-based Japanese artist Noncheleee, who pays homage to the iconic dancehall album art of Wilfred Limonious.",
						},
						{
							content:
								"Part of Time Capsule's Nippon Series—exploring various Japanese musical scenes from the 1970s to the 1990s—the songs on Tokyo Riddim 1976-1985 demonstrate the indirect and creative ways in which musical styles combine, and resulting in something beautifully unique.",
						},
					],
				},
				{
					...
					contentData: [
						{
							content:
								"Mother of the Revolution is the score from a new folk musical based on the life of industrialist Betty Beecroft. The iconic late 18th to early-19th century figure is known for her role as manager of Kirkstall Forge—the longest continually-running metalworking site in England, until its closure in 1995.",
						},
						{
							content:
								"Operating at a significant time in Yorkshire's industrial history, Beecroft is for many a forgotten figure of female entrepreneurship. The musical unearth's this untold story, shedding light on her personal biography and interweaving it with the history of Kirkstall Forge, and the generations of working communities that followed.",
						},
						{
							content:
								"Developing both the script and the score with locals from the city of Leeds, where its located, the production stays true to the tradition and spirit of collaboration both Beecroft, the forge, and the locals of the surrounding area have exemplified over the last 275 years. Mother of the Revolution uses a folk music and cultural tradition of the region, rooted in its working class heritage and industrial history.",
						},
					],
				},
				{
					...
					contentData: [
						{
							content:
								"The Los Angeles-based experimental hiphop, RnB, and pop trio—featuring Jadagrace, SWIM, and TJ Online—doesn't shy away from their beginnings as child entertainers. Meeting over various and serendipitous points in their lives through classes and TV/film sets, they found solace in one another as they navigated through the entertainment industry at a young age.",
						},
						{
							content:
								"The i was mature for my age, but i was still a child tape follows the album digital release in June, with 16 tracks spanning the genre spectrum from rap to rock and electronica. There are glimmers of Busta Rhymes's 90s progressive flow lead single Nasty, along with elements of the RnB-inflected dance-pop of Y2K-era TLC. Meanwhile, the acoustic guitar ballad of club song :( is a stark illustration of the deep feeling of isolation one feels in a room full of self-destructive people. Together, they go some way in illustrating the sheer emotional range of the album as a whole.",
						},
					],
				},
			],
	...
	},
	{
		...
		content:
			"The best in jazz, RnB, soul, funk and adult contemporary Image: Laolu",
		pageTitle: "Qrates Recommends",
		storiesDetailsData: {
			topSectionData: {
				contentData: [
					{
						content:
							"Slip out of the summer body and into winter hibernation with this smooth and sensual selection of performers, bands, and producer with an ear for rhythm and grooves.",
					},
					{
						content:
							"Featuring the doo-wop harmonies of Chicano ensemble Joaquin, soulful South London singing of Laolu, sampling super-producer Aviad, and the cult Japanese funk of Petrolz.",
					},
				],
			},
			middleSectionData: [
				...
				},
				{
					...
					contentData: [
						...
						{
							content:
								"The album is a collection of productions by the Boston-based teen for the aforementioned Atlanta rapper, along with the likes of Dre Wave$, Kwame Adu, Jay Hollywood, My Favorite Color, and more. Exhibiting a diverse range of beats—from the soulful to the lush, the groovy to the trap-like—on standouts like Lift Me Up and My Love, Best Frends and Pray for Malibu, the sheer variety of ideas and featured aritsts is enough to demonstrate the ability of a young producer with a very bright future.",
						},
					],
				},
			],
	...
	},
	{
		...
		content:
			"Guitar-based folk, indie, blues, rock and everything in-between. Image: Bathory",
		pageTitle: "Qrates Recommends",
		storiesDetailsData: {
			topSectionData: {
				contentData: [
					{
						content:
							"These are three records that are embracing the darkness as winter looms, in their own unique way. From a cult horror cameo on the otherwise sunny, though eccentric alt-folk of Ryan Liberty Megan to the iconic extreme metal of the late-great, Quorthon of Bathory, and the rhythmic, new age nu-metal of Ascend The Helix.",
					},
				],
			},
			middleSectionData: [
				{
					...
					contentData: [
						{
							content:
								"A cat-themed indie-rock and folk album from Ryan Liberty Megan, People: El Songo's sound is as uncategorizable as the collision of artists and ideas it presents. The New Paltz, New York-based dad's throaty vocal delivery trundles over the lumbering guitar of lead-single Chorus, where its stacked cast of contributors—including collaborator Paul Moran on slide guitar, Dan Schwartz on drums, and fellow Qrates artist Kendra Mckinley providing backing vocals—is topped only by a closing cameo from none other than cult-horror icon Tom Savini. The Dawn of the Dead and Friday the 13th make-up and FX artist also contributes his voice to the heraldic fanfare of the album intro.",
						},
						{
							content:
								"Citing musical influences from the experimental rock of Mr. Bungle and the grunge and sludge metal of Melvins to Wilco's alt-country, Beck's lofi rock, and The Flaming Lips's neo-psychedelia, Megan's artistry draws a dynamic blend of sounds and styles into his unapologetic individuality that captivates and defies convention. This is a debut-album full of fun and lively eccentricity.",
						},
					],
				},
				{
			...
			bottomSectionData: {
				...
				title:
					"Ascend The Helix / Spiral Of Reflection - Vinyl is now available on Qrates.",
			},
		},
	},
	{
		...
		content:
			"Dazzling drops of breaks, rhythm & rhyming in hip hop & rap Featured Image: FVNTVNV",
		pageTitle: "Qrates Recommends",
		storiesDetailsData: {
			topSectionData: {
				contentData: [
			...
			middleSectionData: [
				{
					...
					contentData: [
						{
							content:
								"DJ TWI$T II offers a shadowy and profound journey into old school hip hop and trip hop. The Ukrainian DJ and producer's debut album, Confrontation of Mind, features 16 haunting, dubbed-out tracks that incorporate vinyl samples, capturing the charm and atmosphere of 90s-era rap.",
						},
						{
							content:
								"Created during the conflict in Ukraine, each song is infused with the emotions experienced during that time, from the lumbering beats and echoing delay of What Do You Think Of Real Fear? to the skulking jazz guitar of The Watts Prophets's spoken word samples on Freedom On Your Blood.",
						},
						{
							content:
								"As an underground hip-hop beatmaker and founder of Kyiv and Amsterdam-based cassette tape labels NorthernDirtyStreets Records and Kiew Centraal, DJ TWI$T II's active and independent ethos permeates every edge of these expertly crafted odes to revolution.",
						},
					],
				},
				{
					...
					contentData: [
						{
							content:
								"Spoda aka Mr. Dopeflow joins VStheBest215 for this raw and rousing double LP of hip hop on the heavier side. Champagne Is For Champions showcases the respected Long Island emcees signature rough, gritty, and lyrical delivery, complemented by the soulful boom-bap production of the latter Philadelphia-based producer.",
						},
						{
							content:
								"Including collaborations with A-1 The Chozen on Dooms Day and O-Dawg of the Walkers collective on Aint On Sh*t, the album is a dynamic and unapologetic take on the words and ideas from some of the most relevant rappers coming up on social media today.",
						},
						{
							content:
								"Meanwhile, standout tracks like the grunting, groaning trundle of Different Lane, and the razor-sharp toms of Still The Most keep close to the roots of hip hop, paying homage to the culture at its most authentic.",
						},
					],
				},
				{
					...
					contentData: [
						{
							content:
								"Brian Fanning's FVNTVNV project encompasses a spectrum of musical styles, from smooth sample-based production to powerful original compositions. The Miami-based music producer and songwriter works with a diverse range of sounds catering to different musical preferences, while reflecting on his childhood experiences in the Midwest and his vision of small-town hip hop from the region.",
						},
						{
							content:
			...
			bottomSectionData: {
				...
				title:
					"Spoda x VStheBest215 / Champagne Is For Champions is now available on Qrates.",
			},
		},
	},
	{
		...
		content:
			"From DIY parties in South Bronx, New York to anime-infused rap in 2023, hip-hop continues to live and in a refreshingly eclectic way",
		pageTitle: "Qrates Recommends",
		storiesDetailsData: {
			topSectionData: {
				contentData: [
					...
					{
						content:
							"One of the significant developments in recent years is the rise of streaming platforms and social media, which have had a profound impact on the way hip hop is consumed, shared, and discovered. Artists now have direct access to their audience, allowing for greater artistic independence and the democratization of the business. This has led to a surge in the number of emerging artists, as well as the diversification of hip hop styles and subgenres.",
					},
					{
						content:
							"In terms of musical trends, trap music has remained a dominant contemporary force in hip hop. Characterized by its heavy bass lines, 808 drum patterns, and neck-snapping production it has continued to influence mainstream rap and popular culture.",
					},
				],
			...
			middleSectionData: [
				{
					...
					contentData: [
						...
						{
							content:
								"Navy Blue's music is often characterized by soulful and jazzy production, which creates a reflective and atmospheric backdrop for his lyrics. His unique approach to storytelling has drawn comparisons to influential artists like Earl Sweatshirt and MF DOOM.",
						},
						{
							content:
						...
						{
							content:
								"If a “changing of the guard” in modern hip hop were to be considered, Navy Blue would surely be in the front ranks.",
						},
					],
				},
				{
					...
					contentData: [
						{
							content:
								"He has developed a reputation for his intellectual approach to hip hop and his ability to blend abstract and introspective themes into his music.",
						},
						{
							content:
								"Many of his recent projects have showcased Ferreira's growth as an artist, incorporating elements of jazz and spoken word poetry into his music. R.A.P.'s lyrics often explore complex themes such as identity, race, social issues, and personal introspection. His poetic style and dense wordplay challenge listeners to engage with his music on a deeper level, encouraging thoughtful interpretation and reflection.",
						},
						{
							content:
								"Musically, R.A.P. Ferreira's production draws from a wide range of influences, incorporating elements of jazz, soul, and lo-fi hip hop. The production serves as a rich backing to his intricate lyricism, creating a cohesive and immersive sonic experience. He continues to push artistic boundaries, delivering thought-provoking and intellectually stimulating music that challenges the conventions of the hip hop genre.",
						},
					],
				},
				{
				...
				},
				{
					...
					contentData: [
						...
						{
							content:
								"At the same time, Duckwrth seamlessly incorporates R&B and soul elements into his music. He showcases smooth and soulful vocals, often crooning over melodic instrumentals. His ability to effortlessly switch between rapping and singing adds depth and versatility to his tracks.",
						},
						{
							content:
								"Apart from his solo work, Duckwrth has collaborated with various artists across different genres, including Kiana Ledé, Terrace Martin, and Anderson .Paak, among others. These collaborations have further expanded his reach and allowed him to showcase his versatility as an artist.",
						},
						{
							content:
								"Duckwrth stands out as an artist who pushes boundaries and defies categorization. With his unique blend of musical influences, dynamic performances, and infectious energy, he continues to make a mark in the music industry and captivate audiences with his eclectic sound.",
						},
					],
				},
				{
					...
					contentData: [
						{
							content:
								"Distinctly admired for her energetic and catchy style, TiaCorine has earned the ears of the music industry through her unique blend of rap, trap, and pop sounds.",
						},
						{
							content:
								"TC's anime trap style refers to her incorporation of anime and Japanese pop culture elements into her music and aesthetic. She infuses references to popular anime series, characters, and themes in her music. She often incorporates anime-inspired artwork, sounds effects, imagery, and fashion into her music videos and promotional materials.",
						},
						{
							content:
								"By embracing the anime trap style, she connects with a specific subset of fans who are both anime enthusiasts and rap music listeners. Her incorporation of anime elements allows her to tap into a niche audience while adding a playful and imaginative twist to her music and image.",
						},
						{
							content:
	...
	},
	{
		...
		content:
			"Righteous techno, ethereal electro, and more exciting dancefloor bangers.",
		pageTitle: "Qrates Recommends",
		storiesDetailsData: {
			topSectionData: {
				contentData: [
					{
						content:
							"Follow the buzz of the summer solstice with this selection of the most electric electronic music on Qrates right now.",
					},
					{
						content:
							"These including All India Radio's super-limited run of their crowning debut album, Koro's mysterious house re-edits, and Staris's out-of-this-world alpha wave work, plus the wired rock and EDM soundtrack for gamers from nerdcore hip hop icon Omega Sparx.",
					},
				],
			},
			middleSectionData: [
				{
					...
					contentData: [
						{
							content:
								"Downtempo, atmospheric, trippy, slightly nightmarish, and purposefully imagination-inducing, the Martin Kennedy's ever-prolific All India Radio project's first ever album is a haunting journey into where it all began.",
						},
						{
							content:
								"The Inevitable was first released in 1999, and draws more directly to its original thematic of its titles, taken from India's national broadcaster, with tracks like Hotel Madras and Bollywood Nights. Admittedly, the field recordings and incidental sounds from the country are minimal but the sense of a far away place beyond our own is expertly evoked in its calm ambient swells and guitar delay.",
						},
						{
							content:
								"The Melbourne-based musician and artist who already an icon among many, so with a super-limited availability of only 100 copies, you'll be wise to get to it with preorders.",
						},
					],
				},
				{
					...
					contentData: [
						{
							content:
								"Japanese producer Kousuke Awane's Koro project releases a mysterious re-edit series by taking iconic jazz pianist Herbie Hancock's famously forward-thinking 1977 Japan-only release Nobu, and making it into the house track it was always meant to be. The original melodic beat meets a heavier kick drum and bass line that transforms the track into a perfect dance-floor experience.",
						},
						{
							content:
								"The same goes for the 12-inch vinyl single's B-side, a warped and winding reconstruction of music from Jo Hisaishi's Nausicaä of the Valley of the Wind animation, which takes the emotive fantasy atmospherics of the original and twists it into a rolling engine of motion and movement. The spellbinding songs accompanying the adventures of the young teenager from a dystopian future, is twisted and turned into a fantastical tune of the typical repetitive four-on-the-floor beats of the 120BPM club genre. The abstract arpeggio is simply dessert.",
						},
					],
				},
				{
	...
	},
	{
		...
		content:
			"Guitar-based folk, indie, blues, rock and everything in-between. Image: Ephemeral Sky",
		pageTitle: "Qrates Recommends",
		storiesDetailsData: {
			topSectionData: {
				contentData: [
					{
						content:
							"Catch up on the latest metal, indie, and rock records in this selection by Qrates, from the cinematic breakout record by Zeeminar Alyumshka and Ephemeral Sky’s montage of metal genres, as well as an unexpected indie gem from Too Many Records’ stalwarts, GOOSE!.",
					},
				],
			},
			middleSectionData: [
				{
					...
					contentData: [
						{
							content:
								"Too Many Records—the label known for managing crowdfunds for bands like Fort Vine and even one of King Gizzard & the Lizard Wizard's famous bootlegs—returns to Qrates to launch a heartfelt vinyl edition of What Now?, the debut album from duo, GOOSE! (don't be frightened).",
						},
						{
							content:
								"Based in windy Portland, Oregon, band members Matt Mena and Laura May have built a growing fanbase from managing the label's physical disc store. Despite their subdued visual identity and limited social media presence, GOOSE! make up for it with their disruptive approach to the indie genre that oscillates between subtractive and additive composition. It’s the type of record with breathtaking guitar-vocal solos that end up punching upwards into full-blown rock. This is a must-have album for all the indie fanatics and legacy TMR fans out there.",
						},
					],
				},
				{
					title:
						"MY NAME IS ZEEMINAR ALYUMSHKA AND I WANT TO KISS YOUR HANDS AND FEET WITH MY SWEET MUSIC UNTIL EVERY CELL IN YOUR BODY SHIMMERS / Zeeminar Alyumshka",
					sectionImg: storiesDetailPage8Img3,
					contentData: [
						{
							content:
								"My name is Zeeminar Alyumshka and I want to kiss your hands and feet with my sweet music until every cell in your body shimmers sounds like quite the introduction.",
						},
						{
							content:
								"Trust us, the music is the same. It's loud and open-hearted in a way that might even make you smile. Zeeminar Alyumshka is the alias of French-American Rob Summerlin. Starting his life immersed in French cinema and American road trips set to the tune of Green Day, the artist later relocated to the seaside in 2019. He began exploring music and composition, which led to a creative awakening and the birth of his first songs. Now, they're here on vinyl.",
						},
						{
							content:
								"This record takes listeners on a journey resembling a treasure quest, filled with sonic cliffhangers and cinematic production. It's simply explosive.",
						},
					],
				},
				{
					...
					contentData: [
						{
							content:
								"Fans of metal rejoice at Ephemeral Sky's Philanthrop/ album. This record delves into an introspective exploration of human nature and existence. Seven tracks navigate utopian ideals, fears, warfare, and higher consciousness. Each song draws from a wide range of metal genres, including post-black metal, blackgaze, post-hardcore, slam death metal, jazz, classical, and even ethnic folk influences, delivering an energetic and mystical sound that truly has to be experienced.",
						},
						{
							content:
								"The project began in Kelowna, Canada, in 2012 but didn't emerge until 2020 when the full version of the original demo was recorded in Leiden, Netherlands. By 2022, the first two songs of Philanthrop/ were released, culminating in the album's official launch on April 27 earlier this year.",
						},
						{
							content:
								"In a distinctive aesthetic choice, this vinyl release is limited to 100 copies, each meticulously hand-numbered in red ink. The three colors chosen for the disc are specifically selected to preserve the original sound quality.",
						},
					],
				},
			],
			bottomSectionData: {
				...
				title:
					"GOOSE! (don't be frightened) / What Now? is now available on Qrates.",
			},
		},
	},
	{
	...
	},
	{
		...
		content:
			"Righteous techno, ethereal electro, and more exciting dancefloor bangers.  Image: pluko",
		pageTitle: "Qrates Recommends",
		storiesDetailsData: {
			topSectionData: {
				contentData: [
					...
					{
						content:
							"Featuring a variations on classic music by Croptal, pluko’s latest euphoric electronic album, and kawaii bounce from rising EDM producer, camoufly",
					},
				],
			},
			middleSectionData: [
	...
	},
	{
		...
		content:
			"Dazzling drops of breaks, rhythm & rhyming in hip hop & rap Featured Image: KBSZ BEATS",
		pageTitle: "Qrates Recommends",
		storiesDetailsData: {
			topSectionData: {
				contentData: [
					{
						content:
							"Here's a bunch of burly beats to get you in the mood for the coming summer.",
					},
					{
						content:
							"Featuring a new compilation of sentimental jazz-hop by Jknodic, Cydney Poitier & Soul Lxrd’s motion picture-esque album, plus a look into Hungarian-Slovakian hip hop crew KBSZ BEATS present a release by Lil Dap & Funktasztikus",
					},
				],
			},
			middleSectionData: [
				{
					...
					contentData: [
						{
							content:
								"Jknodic returns to Qrates with his third album release, Rhythms Vol.3, an intrinsically groovy and vibrant playthrough that's perfect for jazz-hop heads looking for an exciting new record. The LP sounds meticulously crafted, showcasing the San Antonio-based beatmaker's aptitude for lofi-infused instrumentals. ",
						},
						{
							content:
								"Songs like LA Trip and Vice Versa transport listeners into a flurry of nocturnal soundscapes, evoking midnight rides on the seemingly never-ending highways between Los Angeles and the artist's hometown of Texas.",
						},
						{
							content:
				...
				{
					title:
						"Uptown Saturday Night—The Motion Picture Soundtrack / Cydney Poitier x Soul Lxrd",
					sectionImg: storiesDetailPage12Img3,
					contentData: [
						{
							content:
								"A quick listen to Cydney Poitier's Uptown Saturday Night—The Motion Picture Soundtrack is like embarking on an exhilarating rollercoaster ride through the vibrant landscapes of hip-hop. Poitier's dynamic vocals carry this album's pulse, weaving a tapestry of stories that echo the soul of the streets.",
						},
						{
							content:
								"Created in collaboration with producer Soul Lxrd and an ensemble of talented artists, each track delivers a symphony filled with distinctive beats and compelling lyrics. On feature track Paris Blues, the Orlando artist's lyricism cuts through riveting RnB samples giving listeners a throwback taste to 90s and early-2000s hip hop.",
						},
						{
							content:
								"Uptown Saturday Night is rich and swagger-filled, promising an immersive journey to anyone willing to sit down through the album's eight tracks—a surefire testament to Poitier's skills as a rapper, visionary, and storyteller.",
						},
					],
				},
				{
	...
	},
	{
		...
		content:
			"Thriving During Lockdown: Swardy talks to us about the inspiration behind his solo EPs, online music festivals and getting punched in the face.",
		pageTitle: "Artists on Qrates",
		storiesDetailsData: {
			topSectionData: {
				contentData: [
			...
			bottomSectionData: {
				...
				title:
					"Swardy / Here On My Own 10 [First Edition] is now available on Qrates.",
			},
		},
	},
	{
		...
		content:
			"Trying to do good: Cory Wong on staying productive through a pandemic & spreading joy through creativity",
		pageTitle: "Artists on Qrates",
		storiesDetailsData: {
			topSectionData: {
				contentData: [
			...
			middleSectionData: [
				{
					...
					contentData: [
						{
							content:
								"This open and explorative attitude is something that's informed by an early experience with a serious blood clot in Wong's teens, where he was confronted with the existential questions of his own mortality, and in doing so found a boundless source of gratitude.",
						},
					],
				},
				{
	...
	},
	{
		...
		content:
			"Essential Listening: Vulfpeck's Theo Katzman on embracing complexity while saying things simply, & the reason he's reissuing his first solo album Romance Without Finance",
		...
		storiesDetailsData: {
			...
			bottomSectionData: {
				...
				title:
					"Theo Katzman / Romance Without Finance - 10th Anniversary First Pressing is now available on Qrates.",
			},
		},
	},
	{
		...
		content:
			"Outside the Box: DUCKWRTH’s Jared Lee on staying independent, building worlds & keeping things fresh with his eight-track release SG8*",
		pageTitle: "Artists on Qrates",
		storiesDetailsData: {
			topSectionData: {
				contentData: [
	...
	},
	{
		...
		storiesDetailsData: {
			topSectionData: {
				...
				artistTitle:
					"The Real Folk Blues (thebishopgame Remix) Mason Lieberman",
			},
			middleSectionData: [
				{
	...
	},
	{
		...
		content:
			"Feeling the time: Kay Suzuki on the Time Capsule reissue label as a future dialogue with the past & seeking spirituality in sound",
		pageTitle: "Artists on Qrates",
		storiesDetailsData: {
			topSectionData: {
				contentData: [
			...
			bottomSectionData: {
				...
				title:
					"Gabrielle Roth & The Mirrors / Selected Works 1985-2005 is now available on Qrates.",
			},
		},
	},
	{
		...
		content:
			"Creating New Worlds: Oracle Sisters talk us through building fictional futures and recording during a pandemic.",
		pageTitle: "Artists on Qrates",
		storiesDetailsData: {
			topSectionData: {
				contentData: [
			...
			middleSectionData: [
				{
					...
					contentData: [
						{
							content:
								"Finland-born Julia Johansen is the third and most recent member of the band, quickly establishing herself as an integral part of the singing and writing team. Oracle Sisters’ music is full of beautifully constructed harmony arrangements that ebb and flow amongst a constant flux of ideas, and Julie helps complete that sound.",
						},
						{
							content:
								"“When we got to Paris, Chris and I made a point to work on our harmonies, and Julie was able to join in pretty easily. She already knew how to sing harmonies and we developed from that”. Julia also fell into playing the drums for the band, even though she was a complete beginner. “She’s naturally very musical and has a very good sense of timing.” says Chris, “She picked it up easily and had a drumming style that leaned very naturally towards what we needed, a very light touch with a lot of space.”",
						},
					],
				},
				{
			...
			bottomSectionData: {
				...
				title:
					"Oracle Sisters / Oracle Sisters - Paris I / Paris II is now available on Qrates.",
			},
		},
	},
	{
		...
		content:
			"All roads lead to Willie: Texan Lifer Kimmie Rhodes on her musical career and playing with friends for the fun of it",
		pageTitle: "Artists on Qrates",
		storiesDetailsData: {
			topSectionData: {
				contentData: [
			...
			bottomSectionData: {
				...
				title:
					"KIMMIE RHODES & WILLIE NELSON / KIMMIE RHODES & WILLIE NELSON | PICTURE IN A FRAME | FIRST PRESSING + LTD is now available on Qrates.",
			},
		},
	},
	{
		...
		content:
			"Bring your own body: Qrion on her shift from being a chiptune-loving bedroom producer in Japan to making bodily EDM from her current base in San Francisco.",
		pageTitle: "Artists on Qrates",
		storiesDetailsData: {
			topSectionData: {
				contentData: [
					{
						content:
							"“One day I brought my body to the record store and that was it,” says Momiji Tsukada about what it was that led her down the EDM path as a Japanese San Francisco transplant. “Here are so many vintage record stores, and I was getting tired of just randomly listening on the internet.”",
					},
					{
						content:
							"Better known by her Qrion alias, the Sapporo-born producer made waves for her percussive chiptune made up mostly of stock Apple sound effects on ‘iPhone Bubbling’. The track was uploaded to SoundCloud and went viral, falling in line with a global movement of young producers connected via the internet.",
					},
				],
			...
			middleSectionData: [
				{
					...
					contentData: [
						{
							content:
								"Qrion: From last October to maybe March, I started getting gigs a lot more than before. Finally, I got used to going back home on weekdays and flying to other cities on weekends. But then we didn't have any gigs suddenly, so I tried to not lose my DJ motivation. I try to jump on Twitch twice a week.",
						},
					],
				},
			],
	...
	},
	{
		...
		content:
			"Rett Madison is part of a new wave of indie-folk & rock artists looking beyond binaries & diving deep into their difference",
		pageTitle: "Artists on Qrates",
		storiesDetailsData: {
			topSectionData: {
				contentData: [
			...
			middleSectionData: [
				{
					...
					contentData: [
						{
							content:
								"I can't recall the first record I ever bought, but I inherited a ton from my parents collection. I think anyone who collects vinyl has a dusty version of Dark Side that probably had pounds of weed rolled on it by their parents, so I'm goin with that! hahaha",
						},
					],
				},
				{
					...
					contentData: [
						{
							content:
								"My homie 10.4 Rog who I am in a group called Figmore with put me on to this record. I believe his buddy Omari Jazz put him on. This record is incredible. It reminds me of Stereolab meeting Flying Lotus but in a singer-songwriter world. It's amazing.",
						},
					],
				},
				{
					...
					contentData: [
						{
							content:
								"This album really changed my whole approach to songwriting & arrangement. The lyrics, instrumentation & use of storytelling in this record are god tier. So tasteful & full of really addicting musical motifs I always can come back to. Would love to work with Andy some day.",
						},
					],
				},
				{
					...
					contentData: [
						{
							content:
								"I was listening to this record a lot when I was writing the songs for Overthin King. Chaz is a huge inspiration in terms of reinventing himself with each release & making music in every genre. The songwriting & overall feel of this record really helped inform a lot of decisions I made when making Overthin King.",
						},
					],
				},
				{
	...
	},
	{
		...
		storiesDetailsData: {
			...
			middleSectionData: [
				...
				},
				{
					...
					contentData: [
						{
							content:
								"Fooling around with a loop station (Boss RC-1) started the melodic guitar journey for me. It really helped me to find my style. But I was never sure if those loops without vocals could actually grow into something bigger. Years later the music of Khruangbin confirmed the strength and value of instrumental tracks. It's one of the few great albums I could listen to multiple times a day.",
						},
					],
				},
				{
			...
			bottomSectionData: {
				...
				title:
					"Transfer To Graham / Transfer To Graham is now available on Qrates.",
			},
		},
	},
	{
		...
		content:
			"Wax Heart is a series featuring an artist and the five records that made them who they are today",
		pageTitle: "Wax Heart",
		storiesDetailsData: {
			topSectionData: {
				contentData: [
					{
						content:
							"Most producers say that the way to stand out in the lo-fi game is mainly about having your own sound, says Budapest-based beatmaker Dániel Fazekas (aka 桜Sakura) about the unique sonic textures and techniques that go into making his brand of electronic jazz and boom bap. I love when a banger beat has a colourful soundscape, with many different instruments, so I'm going to find as many as I can.",
					},
					{
						content:
		...
		storiesDetailsData: {
			topSectionData: {
				contentData: [
					...
					{
						content:
							"First released as a now sold-out cassette via net label L33K5P1N 84574RD5 last year, McNicholl's we are not the same LP reissue is available for preorder on Qrates until June 20. The eclectic combination of styles crossing the lo-fi and analogue technological spectrum is deep foray into the the inner workings of the dreamy, sometimes doom-y subconscious mind.",
					},
					{
						content:
							"As part of Qrates's ongoing Wax Heart Series, shares four records that have influenced him the most so far.",
					},
				],
			},
			middleSectionData: [
			...
			bottomSectionData: {
				...
				title:
					"feature creep / we are not the same is now available on Qrates.",
			},
		},
	},
	{
		...
		storiesDetailsData: {
			topSectionData: {
				contentData: [
					{
						content:
							"Since I already made two EPs on Qrates, I decided to go for a third one and complete the trilogy, says self-proclaimed least mysterious mysterious producer camoufly about his latest release, “Faith, available now for vinyl preorder via Qrates until June 12. Overall, I love music on all formats, and I'm a vinyl collector too, so it's a pleasure for me to have my music on vinyl.",
					},
					{
						content:
							"The 2021 Audius Award winner makes every type of electronic music in existence, not least the kinds of beats that incorporate a bass and nu-disco aesthetic with Eastern-inspired sounds and he calls kawaii bounce. camoufly draws inspiration from the likes of Mura Masa, Sam Gellaitry and Lido, while his tastes are as eclectic as mentioning hip hop artist Kendrick Lamar and Disney star-come-pop singer Olivia Rodrigo in the same breath, while owning every Daft Punk record under the sun.",
					},
					{
						content:
							"Find out more about camoufly's five records that have influenced him the most so far, as part of Qrates's ongoing Wax Heart Series, below.",
					},
				],
			},
			middleSectionData: [
				...
				{
					title:
						"Good Kid, M.A.A.D. City & To Pimp a Butterfly / Kendrick Lamar & Sour / Olivia Rodrigo",
					sectionImg: storiesDetailPage28Img3,
					contentData: [
						{
							content:
								"These are three records that I've bought recently, just the other day. The first one is Good Kid, M.A.A.D. City by Kendrick Lamar. The second one is To Pimp a Butterfly still by Kendrick Lamar, and the third one is Sour by Olivia Rodrigo. I know it's very different but I love that album.",
						},
					],
				},
				{
				...
				},
				{
					...
					contentData: [
						{
							content:
								"In general, the records that inspire me the most are the ones that I listen to the most when I'm making music. So, I will say that a major inspiration for my latest project was Cashmere Cat's Wedding Bells. I think it's an incredible EP.",
						},
					],
				},
				{
			...
			middleSectionData: [
				{
					...
					contentData: [
						{
							content:
								"The first vinyl I ever bought was Black Sands. Back then I listened to this album a lot, I love it very much. It was a lot of inspiration back then. Even now, it's a big part of my music. It's like a reference. [Bonobo] is the first ever artist I discovered in this genre.",
						},
					],
				},
				{
					...
					contentData: [
						{
							content:
								"The last record I bought was Somnifère from a band called Efy Hecks, a band from Montreal. They do some really nice stuff, it's some rock and psychedelic. They have some cool progressions in their music, a lot of instruments too. They have cool tracks and I really recommend this album.",
						},
					],
				},
				{
					...
					contentData: [
						{
							content:
								"The record that influenced me the most is debut album of Flume. It's just incredible, I don't know how much time I've listened to it. All of the elements that I love in music are there—good grooves, good instrumentals. It just it's an amazing album.",
						},
					],
				},
				{
					...
					contentData: [
						{
							content:
								"The artwork that inspired me, especially for this album, is the type of artwork that requires photography. I'm a big fan of photography myself. I was really inspired by an album like Fleetwood Mac's Tusk, putting a photograph in the front sleeve.",
						},
					],
				},
				{
					...
					contentData: [
						{
							content:
								"My favourite record store so far is is a place in Quebec called Societe des Loisirs. This is a very cool place, very chill very, very calm. They have a great selection, as well. It's very indie and they have a lot of underground artists, so it's very cool to hang out and discover new music.",
						},
					],
				},
			],
			...
			middleSectionData: [
				{
					...
					contentData: [
						{
							content:
								"The first record I ever bought was rumors by Fleetwood Mac. I think I bought it at Rough Trade in New York when I was living in New York in my 20s. I do still have it and I think I bought it because I was familiar with the cover. I love the record and it sounds so much better on vinyl.",
						},
					],
				},
				{
					...
					contentData: [
						{
							content:
								"The last record I bought is the Getz/Gilberto album Stan Getz and João Gilberto play all Antônio Carlos Jobim tunes, my favourite. The best part about this record is it really does give you an experience. It feels like you're in the room with them and all those songs are such classics. I studied Brazilian music in college so [they're] just reminiscent, and familiar, and feel like home.",
						},
					],
				},
				{
			...
			middleSectionData: [
				{
					...
					contentData: [
						{
							content:
								"We freakishly have the exact same first record, and I still love that record to death. It's still one of my favorite. It was kind of the beginning of me trying to reproduce these kinds of hip hop grooves and play this music. Questlove was a massive inspiration and he played drums on that record.—Carson Gant",
						},
					],
				},
				{
					...
					contentData: [
						{
							content:
								"I got it at my local favorite record store. It's called Recordland, here in Calgary, Alberta, Canada. I'm obsessed with Yussef Dayes as a drummer. He's incredible, he's so versatile, and all the projects he does are amazing. It was one of my favorite mixing engineers who mixed that record, Russell. I had to get it. It's amazing and I blast it, often. It was my COVID record.",
						},
					],
				},
				{
	...
	},
	{
		...
		storiesDetailsData: {
			...
			bottomSectionData: {
				...
				title:
					"Paul & The Microcosm / Boogienite EP - Spilled Coke Edition is now available on Qrates.",
			},
		},
	},
	{
		...
		storiesDetailsData: {
			...
			middleSectionData: [
				{
					...
					contentData: [
						{
							content:
								"The first vinyl record that I ever had as a child was a tune called Widgie The Whale by Rocking Horse Orchestra & Chorus. I had one of these little Fisher Price turntables and this was a song about a walking whale and I would just post up on the couch and dance my little tushy off.",
						},
					],
				},
				{
					title:
						"Is My Living In Vain / The Clark Sisters with Mattie Moss Clark",
					sectionImg: storiesDetailPage34Img3,
					contentData: [
						{
							content:
								"I just found a copy of The Clark Sisters with Mattie Moss Clark record called Is My Living In Vain, recorded live in Detroit. It's one of the greatest live gospel records I've ever come across. It's totally fantastic. I highly recommend checking it out.",
						},
					],
				},
				{
			...
			bottomSectionData: {
				...
				title:
					"Swatkins / FRIENDS AND OTHER NECESSITIES is now available on Qrates.",
			},
		},
	},
	{
			...
			middleSectionData: [
				{
					...
					contentData: [
						{
							content:
								"This album defined rock music for me- for a very long time. With epic tracks like The Lemon Song, Ramble On, Moby Dick and Heartbreaker… I spun this record over and over- it opened the door to finding new music, and influenced my views on rock guitar- bending traditional genres.",
						},
					],
				},
				{
					...
					contentData: [
						{
							content:
								"The Godfather of Soul. This album screams of funk and soul — especially with his literal scream in that “Lost Someone” or in hits like “Try Me” and “Please Please Me.”",
						},
					],
				},
				{
				...
				},
				{
					...
					contentData: [
						{
							content:
								"Probably our main modern musical influence right now. This album carved a path forward through so many new melodic /sonic ideas for us as a band.",
						},
					],
				},
				{
					...
					contentData: [{ content: "Baby makin’ music." }],
				},
			],
			bottomSectionData: {
	...
	},
	{
		...
		content:
			"We take a deep dive into the rise of the vinyl record in a time of digital downloads and very fast culture.",
		...
		storiesDetailsData: {
			topSectionData: {
				contentData: [
					...
					{
						content:
							"Through all of that, the warmth of sound and design aesthetic of vinyl records has stood uncontested, its weight and appeal as an object and an artwork persisting throughout.",
					},
					{
						content:
							"“I think vinyl sounds way better than digital because it doesn't compress the sound,” says Japanese progressive house DJ and Qrates campaign alum Qrion. “The needle makes really warm noises.”",
					},
				],
			},
			middleSectionData: [
				...
				},
				{
					...
					contentData: [
						...
						{
							content:
								"Whatever it might be, anyone with a passion will tell you that there’s no limit to the level of research and discovery around their chosen subject—which includes the history of its production and the changing ways it has been mediated over time.",
						},
					],
				},
			],
	...
	},
	{
		...
		content:
			"We take a look at the wonderful coming together of vinyl and video game soundtracks and how these two polarising formats came to unite as one.",
		...
		storiesDetailsData: {
			topSectionData: {
				contentData: [
					{
						content:
							"Music and video games are two of the most enjoyed pastimes throughout the entire world. You can’t turn on a television without hearing a chart-topping track hit your ears or an advert for the latest shoot-em-up or sports sim being beamed directly into your brain. Recently, these two creative worlds have begun to collide with video game soundtracks on vinyl becoming extremely popular. But why has this happened?",
					},
					{
						content:
							"Although being invented decades apart, vinyl and video games do have a lot in common when you think about it. They are both extremely collectible, they give fans a way to show off their passion for something they love and they allow the listener to revel in a sense of nostalgia for something they enjoy.",
					},
					{
						content:
							"To further understand why vinyl and video games have proved a popular joint force, it’s useful to know a bit more about the history of video games and the kind of soundtracks that have accompanied them over the years.",
					},
				],
			...
			middleSectionData: [
				...
				},
				{
					...
					contentData: [
						{
							content:
								"Touted as having one of the best scripts and stories of any video game, The Last of Us had to have a soundtrack to match. It doesn’t disappoint. A third-person action-adventure game, The Last of Us is set across a post-apocalyptic future where you must defend against hostile creatures and mutated humans. The soundtrack suits the isolated, desperate atmosphere perfectly, playing on ambient sounds and secluded tones, but also able to build in climatic pieces to reflect the more intense sections of the game. A true masterpiece.",
						},
					],
				},
			],
	...
	},
	{
		...
		content:
			"The iconic hip hop record store-come-label and distribution company founder Joseph Abajian gets personal on why he loves records & where the vinyl revival is headed",
			...
			middleSectionData: [
				...
				},
				{
					...
					contentData: [
						{
							content:
								"I would have to say it's the first one I ever got, the Sugarhill Gang 12-inch Rapper's Delight. I got that when I was in fourth grade, I believe. We used to be in class and all of us would just do the Sugarhill beat and stuff.",
						},
					],
				},
				{
	...
	},
	{
		...
		content:
			"The Qrates team shares a list of some of their favourite 2021 records that are available to purchase in time for Christmas",
		...
		storiesDetailsData: {
			topSectionData: {
				contentData: [
					...
					{
						content:
							"Here’s a list of some of our top albums of the year that are available to buy now:",
					},
				],
			...
			middleSectionData: [
				...
				},
				{
					...
					contentData: [
						{
							content:
								"For anyone looking to indulge in the grittier and more honest side of the indie-folk continuum, Rett Madison’s bellowing, queer-feminist anthems and heartbreak ballads toe the line between power and vulnerability. The LA-based, West Virginia-raised singer-songwriter and protégé to Vulfpeck’s  Theo Katzman has been performing around the Californian city since dropping out of a USC music program at 18 years old. Now in their early 20s, Madison has this beautiful debut to show for all their hard work and commitment. It features hits “Kerosene”, “Shame is a River” and the titular “Pin-up Daddy”, which also inspired a stunning depiction of an alternative Pageant Person painted by Miriam Cortez on the cover.",
						},
					],
				},
				{
	...
	},
	{
		...
		storyType: "qrates biz",
		title:
			"A dive into the fast-paced world of Web3 and how it can benefit independent musicians",
		slugs: "story-detail-40",
		content:
			"New platforms like Tellie are making use of blockchain technology to help musicians and creatives regain their independence in the digital age of streaming",
		...
		storiesDetailsData: {
			topSectionData: {
				contentData: [
					...
					{
						content:
							"With the tremendous media interest surrounding non-fungible tokens (NFTs) in 2021—centred around a frenzied hype cycle and large sums paid for digital artworks—some confusion among the public still exists around what exactly Web3 is. It can be an intimidating and mystifying space, with its cryptic terminology that is not yet second nature for today’s internet users.",
					},
				],
			...
			middleSectionData: [
				{
					title:
						"At its core, the concept refers to a new model for the internet that focuses on blockchain technology.",
			...
			bottomSectionData: {
				sectionImg: storiesDetailPage40Img3,
				title:
					"Joyeur / How To Love Yourself And Not Destroy Everything is now available on Qrates.",
			},
		},
	},
	{
		...
		storyType: "qrates biz",
		title:
			"Ten87 on the advantages of long-term studios, fostering community, & changing musical landscapes",
		slugs: "story-detail-41",
		content:
			"The London-based organization's Rob Burn and Julian Prentis talk providing studios and sites for professional development to an array of talent—from independent musicians and producer to engineers and labels",
		...
		storiesDetailsData: {
			topSectionData: {
				contentData: [
					{
						content:
							"“Why isn't there a place that's affordable, that covers all of the checkpoints to put a record out that modern record producers need?” says Ten87 founder Rob Burn about the idea that sparked their London-based studio complex back in 2014. With a background as a record producer, Burn and collaborator Stef “Lakosa” Smith saw a service that was lacking for independent music makers, after working at home and hopping around from studio hire to studio hire. “A soundproof, acoustically-treated space that felt welcoming, but also, that would act as a home for my network.”",
					},
					{
						content:
							"Now consisting of three sites in the north London area of Tottenham, with plans for a further location in south London’s Brixton, Ten87’s concept opens up a discussion on the rapidly changing industry, where musicians are expected to wear the many hats once filled by record labels. With their offer of purpose-built spaces, as well as a site to network and collaborate—similar to the model of affordable visual artist studios and shared workspaces—the organization has quickly built a base for an impressive array of talent. Among the over 150 recording artists and groups at Ten87 include the likes of Leon Vynehall, Maribou State, Mount Kimbie, Hinako Omori, TSHA, Ahadadream, and more. “Today, we're blessed to be home to an incredible community of independent artists, producers, engineers mostly, but also some labels,” Burn explains. “Now we've got a public-facing, day-hire space, which is open for private hire, we've started seeing some incredible credits and artists use that space, as well.”",
					},
				],
			},
			middleSectionData: [
				{
					...
					contentData: [
						{
							content:
								"The brunt of Ten87’s spaces are a blank slate for artists to bring their own equipment and call the sites home. “I think that's what makes it really attractive for a lot of people,” explains Burn. “The fact that they can come in, put their own stamp on a space, and bring all of the equipment they've amassed over their life.” Through all this, fostering community is key,showing what’s missing from the professional development of artists in increasingly isolated home recording scenarios. “The vast majority of the spaces at Ten87 are designed for long-term residencies for those artists, producers, musicians.”",
						},
						{
							content:
								"We spoke with Ten87’s founder Rob Burn and brand manager Julian Prentis on some of the novel challenges facing independent musicians today, as well as how their unique studio model is filling the gaps.",
						},
					],
				},
				{
	...
	},
	{
		...
		content:
			"It’s one thing to command a sizable base of fans and admirers who engage with your music online. It’s another to be able to monetize it so you can keep doing what you’re doing. ",
		pageTitle: "Discover",
		storiesDetailsData: {
			topSectionData: {
				contentData: [
					{
						content:
							"One of the greatest strengths of the digital era is also its greatest weakness—where media accessibility and ease of distribution also makes consumers less likely to pay for it.",
					},
					{
						content:
							"Producing vinyl is one way to overcome this pitfall, providing listeners with an alternative format for appreciating their favourite music by being given the opportunity to own a part of an artist’s hard work in the collectible form of an analogue object that looks as good as it sounds.",
					},
					{
						content:
							"By providing an effective platform for first-time vinyl record producers with little idea of the scale of a project, Qrates has seen so many of its artists become astonished by the level of interest from the fans.",
					},
					{
						content:
							"These include popular hip-hop artist Sol’s long-overdue pressing of his seminal Yours Truly album—first released in 2012—and Mason Lieberman’s Cowboy Bebop theme song charity arrangement, which out-sold its initial target of one hundred seven-inch single releases, 28-times over. Not including Pomplamoose & John Schroeder En Français EP of French covers, here’s a list of Qrates’ top five projects ever sold for context.",
					},
				],
			},
			middleSectionData: [
				...
				},
				{
					...
					contentData: [
						{
							content:
								"The power of the internet meant that Kevin Penkin could make a name for himself as a much sought-after producer from his home in Perth, Western Australia. He collaborated with eminent Japanese musician and composer Nobuo Uematsu on video game Jyuzaengi: Engetsu Sangokuden at the tender age of 19. For a time based in London, while attending Royal College of Music, the Melbourne-based composer is by now best known for his 2017 soundtrack to Akihito Tsukushi’s Made in Abyss Manga series, which has had two pressings of over 2,000 vinyl pre-orders through Qrates. Penkin currently has a live campaign for the OST of Korean web manhwa, Tower of God, which features additional composition from regular collaborator Mason Lieberman, whose “The Real Folk Blues” limited edition charity 7-inch release, in turn, features Penkin on flute.",
						},
					],
				},
			],
